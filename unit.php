...
<form action="sort2.php" method="post">
	...
	<body>
		<center>
			...
			<table>
				<div class="tanggalwaktu">
					<tr>
						<td>Tanggal Awal</td>
						<td>: </td>
						<td><input type="text" id="datetime1" name="tanggal_awal" autocomplete="off" autofocus required></td>

						<td>Tanggal Akhir</td>
						<td>: </td>
						<td><input type="text" id="datetime2" name="tanggal_akhir" autocomplete="off" autofocus required></td>
					</tr>
			</table>
			</div>
			...
			<form action="index.html" post="action">
